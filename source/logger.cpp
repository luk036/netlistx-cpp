 ...
 *
 * This file implements the logging functionality for the netlistx library
...
namespace netlistx {
    ...
    auto make_file_logger() noexcept -> std::shared_ptr<spdlog::logger> {
        auto l = spdlog::basic_logger_mt("file_logger", "netlistx.log");
     ...
     *
     * This function creates a file logger that writes to "netlistx.log",
    ...
    void log_with_spdlog(const std::string& message) {
        ...
        spdlog::info("NetlistX message: {}", message);
    }
